...
enum ImGuiInputTextFlags_
{
    ...
    //Currency Converter Tool Input_flags
    ImGuiInputTextFlags_CurrencyConverterTool = ImGuiInputTextFlags_CharsScientific | ImGuiInputTextFlags_AllowTabInput | ImGuiInputTextFlags_EscapeClearsAll,
